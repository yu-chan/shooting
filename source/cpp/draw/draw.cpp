...
void setCamera() {
	...
	VECTOR camera_pos = VGet(sub[0].x, sub[0].y + 10.0f, sub[0].z - 30); //ƒJƒƒ‰‚ÌˆÊ’u
	VECTOR look = VGet(0.0f, 0.0f, 30.0f); //ƒJƒƒ‰‚Ì’‹“_(ƒJƒƒ‰‚ÌÀ•W‚©‚ç‘«‚µ‚½‚à‚Ì)
	look = VAdd(camera_pos, look);
	...
	SetCameraPositionAndTarget_UpVecY(camera_pos, look);
